...
(function () {
    ...
    if (!document.getElementById('snapinStyle')) {
        var css = '.invisibleWhileLoading .content, .embeddedServiceLiveAgentStateChatHeader .content{background: #222 !important;}.embeddedServiceLiveAgentStateChatItem.chatMessage{margin-top: 0px !important; min-height: 0px !important;} .embeddedServiceSidebarMinimizedDefaultUI .content {background: #0085C3 !important;} [embeddedservice-chatheader_chatheader-host]{background-color:#0085c3 !important}.embeddedServiceLiveAgentStateChatAvatar.isLightningOutContext .agentIconColor0{background-color:#0085c3}.embeddedServiceLiveAgentStateChatPlaintextMessageDefaultUI.chasitor.plaintextContent{background-color:#0085c3}.embeddedServiceSidebarButton{background-color:#0085c3}.embeddedServiceSidebarButton:active,.embeddedServiceSidebarButton:hover{background-color:#72afd2} .embeddedServiceSidebarMinimizedDefaultUI{background-color: #0085C3 !important;border-color: #0085C3 !important}', //FY23-Story #9798804
