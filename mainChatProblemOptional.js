...
function checkIfIssueDescIsOptional(snapInObject, preChatlableObject){
    if("issueVal" in snapInObject && snapInObject.issueVal != "" && snapInObject.issueVal != null && snapInObject.issueVal != undefined && snapInObject.issueVal !='None' && document.getElementById("Issue_Description_Label")){
        ...
        let Issue_Description_Label = document.getElementById("Issue_Description_Label");
        Issue_Description_Label.appendChild(optionalLabel);
