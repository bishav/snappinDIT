...
function GetCoveoPopoverResult(timeout) {
    ...
    if (isCoveoSearchEnabled === true && textLength > 1 && $('#search').hasClass('coveo-hidden') === false && $('#search').find('div.CoveoResult').length !== 0) {
        ...
        }, 1200);// delay is required to snyc up with result.           
    }
    else {
