...
function createCustPreChat(preChatlableObject , user, subscriptionList) {
    ...
    if (subscriptionList && subscriptionList.length > 1) {//If number of subscrition is greated than 1
        ...
        subscriptionDom = '<li class="readonlyContainer"><div><b style="margin-right:16px">'+ preChatlableObject.subscription +' </b><span>'+ subscriptionList[0] +'</span></div></li><li id="cusPreChat-loaderDisplay" class="cusPreChat-loaderDisplay"><div class="cusPreChat-loader"></div></li>';
    ...
    document.getElementById("cusPreChat-nextBtn").addEventListener("click", function () {
        pushToRouting(document.getElementById("cusPreChat-subscription").value)
    });
...
function showRestOfPrechatForm(routingResultObject){
