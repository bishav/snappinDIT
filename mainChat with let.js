...
function isHesAdminChat(snapInObject){
    ...
    // else
    //     return false; 
    if ("requestType" in snapInObject && snapInObject.requestType == "HES Admin Chat")
        return true; 
    else
        return false; 
}
