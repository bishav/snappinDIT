...
function keypressFieldValidation() {
    ...
    $(window).bind("paste", function(e) {
        var t, a = e.target.id;
        switch (window.clipboardData && window.clipboardData.getData ? t = window.clipboardData.getData("Text") : e.originalEvent.clipboardData && e.originalEvent.clipboardData.getData && (t = e.originalEvent.clipboardData.getData("text/plain")),
        a) {
        case "FirstName":
        case "LastName":
            0 == /^[a-zA-Z ]*$/.test(t) && (e.preventDefault(),
            alert("You are trying to paste an invalid text."));
            break;
        case "Primary_Phone__c":
            0 == /^[0-9-]*$/.test(t) && (e.preventDefault(),
            alert("You are trying to paste an invalid text."));
            break;
        case "Issue_Description__c":
            ...
            break;
        case "Email":
            0 == /^[a-zA-Z0-9%()#@_& -]*$/.test(t) && (e.preventDefault(),
            alert("You are trying to paste an invalid text."))
        }
    })
}
function translation(e) {
    return "ja" == e ? (this.issue = "Issue",
    this.firstName = "名",
    this.lastName = "姓",
    this.emailAdd = "メール",
    ...
    this.language = "ja") : "ko" == e ? (this.issue = "Issue",
    this.firstName = "이름",
    this.lastName = "성",
    this.emailAdd = "이메일",
    ...
    this.characters = "characters",
    this.language = "ko") : "es" == e ? (this.issue = "Issue",
    ...
    this.characters = "characters",
    this.language = "es") : "es_MX" == e ? (this.issue = "Issue",
    this.firstName = "Nombre",
    this.lastName = "Apellidos",
    this.emailAdd = "Correo electrónico",
    ...
    this.characters = "characters",
    this.language = "es_MX") : "zh-CN" == e ? (this.issue = "Issue",
    this.firstName = "名",
    this.lastName = "姓",
    this.emailAdd = "电子邮件",
    ...
    this.issueDesc = "问题说明",
    this.characters = "characters",
    this.language = "zh-CN") : "pt" == e ? (this.issue = "Issue",
    this.firstName = "Nome",
    ...
    this.characters = "characters",
    this.language = "pt") : "pt_BR" == e ? (this.issue = "Issue",
    this.firstName = "Nome",
    this.lastName = "Sobrenome",
    this.emailAdd = "Email",
    this.primPhone = "Número de Telefone Principal",
    this.issueDesc = "descrição do problema",
    this.characters = "characters",
    this.language = "pt") : "nl" == e ? (this.issue = "Issue",
    ...
    this.characters = "characters",
    this.language = "nl") : "nl_NL" == e ? (this.issue = "Issue",
    this.firstName = "Voornaam",
    this.lastName = "Achternaam",
    this.emailAdd = "E-mail",
    this.primPhone = "Primair telefoonnummer",
    this.issueDesc = "Probleem Beschrijving",
    this.characters = "characters",
    this.language = "nl") : (this.issue = "Issue",
...
"function" == typeof triggerSnapin && triggerSnapin(),
